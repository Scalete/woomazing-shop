...
export const About: React.FC = () => {
    return (
        <>
            ...
            <TitleBreadcrumbs title='О бренде' breadcrumbs={[{link: `${process.env.REACT_APP_HOME_URL}`, name: 'Главная'}, {link: `${process.env.REACT_APP_HOME_URL}`, name: 'О бренде'}]}/>
            <section className="about">
                <div className="container">
                    ...
                    <Link to={`${process.env.REACT_APP_HOME_URL}shop`} className="action main">Перейти в магазин</Link>
                </div>
            </section>
        </>
    );
